...
export class Post {
  ...
  get Template() {
    return /* html */ `
    <div class="card m-2 masonry-with-columns" style="background: #F19953" onclick="app.postsController.drawModal('${this.id}', '${this.creatorId}')" data-bs-toggle="modal" data-bs-target="#exampleModal">
